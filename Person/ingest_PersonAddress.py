...
PG_DATABASE = "raw"
PG_SCHEMA = "Person"  # Schema for the Person tables
...
try:
    print("🔄 Fetching Address data from SQL Server...")
    ...
    print("🚀 Loading Address data into PostgreSQL...")
    df.to_sql("address", pg_engine, schema=PG_SCHEMA, if_exists='replace', index=False, chunksize=5000, dtype={"rowguid": UUID})

    print("✅ Person.Address table transferred successfully!")
except Exception as e:
    print(f"❌ Error transferring Person.Address table: {e}")
